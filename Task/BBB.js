...
步步宝 
下载地址http://bububao.yichengw.cn/?id=525008
[rewrite_local]
#步步宝
https://bububao.duoshoutuan.com/user/profile url script-request-header https://qxzy.top/rules/QuantumultX/js/bbb.js

[task_local]
0,30 * * * * https://qxzy.top/rules/QuantumultX/js/bbb.js, tag=步步宝,

[mitm]
bububao.duoshoutuan.com
...
loon
[Script]
http-request https://bububao.duoshoutuan.com/user/profile script-path= https://qxzy.top/rules/QuantumultX/js/bbb.js, timeout=10, tag= 步步宝

cron "0,30 * * * *" script-path= https://qxzy.top/rules/QuantumultX/js/bbb.js, tag= 步步宝

surge

步步宝 = type=cron,cronexp="0,30 * * * *",wake-system=1,script-path=https://qxzy.top/rules/QuantumultX/js/bbb.js,script-update-interval=0
步步宝 = type=http-request,pattern=https://bububao.duoshoutuan.com/user/profile,requires-body=0,max-size=0,script-path=https://qxzy.top/rules/QuantumultX/js/bbb.js,script-update-interval=0
